...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo site_url('assets/plugins/jquery-fancybox/jquery.fancybox.js'); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        tinymce.PluginManager.add('dgmedia', function (editor, url) {
            ...
            editor.addButton('dgmedia', {
                ...
                onclick: function () {
                    jQuery.fancybox({
                        href: '<?php echo site_url('index.php/media/modals/descriptMedia/2'); ?>',
                        type: 'iframe'
                    });
                }
            });
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="panel_tab2_example1">
                    ...
                    <div style="display:none;">
                        <input type="text" name="product[title]" value="<?php echo setValue($product, 'title', ''); ?>"
                               placeholder="<?php lang('product_name'); ?>" id="product-name" data-minlength="2"
                               data-maxlength="250" data-msg="<?php lang('product_name_validate_msg'); ?>"
                               class="form-control validate required">
                        <textarea name="product[description]" class="product_description"
                                  style="width:100%;"><?php echo setValue($product, 'description', ''); ?></textarea>
                        <textarea name="product[short_description]" class="short_description"
                                  rows="3"><?php echo setValue($product, 'short_description', ''); ?></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="product[size]" class="text-edittor"
                                          style="width:100%;"><?php echo setValue($product, 'size', ''); ?></textarea>
                            </div>
                        </div>
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-tools">
                                        <a href="javascript:void(0);"
                                           class="btn btn-xs btn-link panel-collapse collapses"></a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <label
                                        id="product_categories-lable"><?php echo lang('product_add_categories'); ?></label>
                                    <button type="button" autocomplete="off" onclick="dgUI.product.removeCate(this);"
                                            id="loading-example-btn" data-loading-text="Loading..."
                                    ...
                                    <div class="form-group">
                                        <a href="javascript:void(0)"
                                           onclick="dgUI.product.addCategoryJs(this)"><?php echo lang('product_add_category'); ?></a>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="add-new-category" style="display:none;">
                                            ...
                                            <!-- category language -->
                                            <div class="form-group">
                                                <input type="text" class="add_new_category form-control input-sm"
                                                       placeholder="<?php echo lang('product_title_category'); ?>"
                                                       autocomplete="off">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="product-category-parent">
                                                    <option
                                                        value="0"><?php echo lang('product_parent_category'); ?></option>
                                                    <?php
                                            ...
                                            <div class="form-group">
                                                <a href="javascript:void(0)" class="btn btn-default btn-sm"
                                                   onclick="dgUI.product.addCategoryJs(this, 'save')"><?php echo lang('product_add_category'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default" style="display:none;">
                                ...
                                <div class="panel-body">
                                    <input type="hidden" name="product[image]"
                                           value="<?php echo setValue($product, 'image', ''); ?>" id="products_image"/>
                                    <img width="100" alt="" class="pull-right"
                                         src="<?php echo imageURL(setValue($product, 'image', '')); ?>">
                                    <a href="javascript:void(0)" class="btn btn-default btn-sm"
                                       onclick="jQuery.fancybox( {href : '<?php echo site_url('index.php/media/modals/productImg/1') ?>', type: 'iframe'} );"><?php lang('product_add_image'); ?></a>
                                </div>
                            </div>
                        </div>
                        <!-- End righ -->
                            ...
                            <div class="tabs-content-right col-md-9">
                                <div id="tabs-1">
                                    <div style="display:none;">
                                        <?php if (setValue($product, 'published', 1) == 1) { ?>
                                            <input type="checkbox" name="product[published]" value="1"
                                                   checked="checked">
                                        <?php } else { ?>
                                            <input type="checkbox" name="product[published]" value="0">
                                        <?php } ?>
                                        <input type="text" class="form-control product_sku input-sm validate required"
                                               name="product[sku]" value="<?php echo setValue($product, 'sku', ''); ?>"
                                               data-minlength="2" data-maxlength="250"
                                               data-msg="<?php lang('product_sku_validate_msg'); ?>"
                                               placeholder="<?php lang('product_sku'); ?>">
                                        <input type="text" class="form-control input-sm product_price"
                                               name="product[price]"
                                               value="<?php echo setValue($product, 'price', ''); ?>"
                                               placeholder="<?php lang('product_regular_price'); ?>">
                                    </div>
                                    ...
                                    <div class="form-group" id="prices-quantity">
                                        <div class="row-prices" style="display:none;">
                                            <input type="text"
                                                   value="<?php echo setValue($product, 'sale_price', ''); ?>"
                                                   class="form-control product_sale_price input-sm"
                                                   name="product[sale_price]"
                                                   placeholder="<?php lang('product_sale_price'); ?>">
                                        </div>
                                        ...
                                        <div class="row-prices">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="javascript:void(0);"
                                                       onclick="dgUI.product.priceQuantity();"
                                                       title="<?php lang('product_quantity_price'); ?>"><?php lang('add_new_quantity_price'); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        if (isset($product->prices) && isset($product->prices->price)) {
                                            ...
                                            for ($i = 0; $i < count($price_min); $i++) {
                                                ...
                                                <div class="row-prices">
                                                    <label
                                                        class="col-sm-3 control-label"><?php lang('product_quantity_price'); ?></label>
                                                    <div class="col-sm-9">
                                                        <div class="form-group row">
                                                            <div class="col-sm-5">
                                                                <input type="text"
                                                                       value="<?php echo $price_price[$i]; ?>"
                                                                       class="form-control input-sm"
                                                                       name="product[prices][price][]"
                                                                       placeholder="<?php lang('product_sale_price'); ?>">
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <a href="javascript:void(0);"
                                                                   onclick="dgUI.product.priceQuantity(this);"
                                                                   title="<?php lang('remove'); ?>"><?php lang('remove'); ?></a>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-5">
                                                                <input type="text" value="<?php echo $price_min[$i]; ?>"
                                                                       class="form-control input-sm"
                                                                       name="product[prices][min_quantity][]"
                                                                       placeholder="<?php lang('product_quantity_min'); ?>">
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <input type="text" value="<?php echo $price_max[$i]; ?>"
                                                                       class="form-control input-sm"
                                                                       name="product[prices][max_quantity][]"
                                                                       placeholder="<?php lang('product_quantity_max'); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="tabs-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="product[min_order]"
                                                   value="<?php echo setValue($product, 'min_order', ''); ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="product[max_oder]"
                                                   value="<?php echo setValue($product, 'max_oder', ''); ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabs-3">
                                        ...
                                        if (isset($product->attributes) && count($product->attributes) > 0 && isset($product->attributes->name)) {
                                            ...
                                            <?php for ($i = 0; $i < count($a_names); $i++) { ?>
                                                <div class="panel panel-simple" data-attribute="<?php echo $i; ?>">
                                                    <div class="panel-heading">
                                                        <span
                                                            class="attribute-title"><?php lang('product_data'); ?></span>
                                                        <a href="javascript:void(0);"
                                                           onclick="dgUI.product.field(this, 'add')"
                                                           data-id="<?php echo $i; ?>" class="btn btn-default btn-xs">
                                                            <?php lang('add'); ?>
                                                        </a>
                                                        <div class="panel-tools">
                                                            <a href="javascript:void(0);"
                                                               class="btn btn-xs btn-link panel-collapse collapses"></a>
                                                            <a href="javascript:void(0);"
                                                               onclick="dgUI.product.attribute(this)"
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-md-4">
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="form-field-22"><?php lang('attribute_name'); ?></label>
                                                                    <input type="text" class="form-control input-sm"
                                                                           value="<?php echo $a_names[$i]; ?>"
                                                                           name="product[fields][<?php echo $i; ?>][name]">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select
                                                                        name="product[fields][<?php echo $i; ?>][type]"
                                                                        class="fields-type form-control input-sm">
                                                                        <option
                                                                            value="selectbox" <?php if ($o_type[$i] == 'selectbox') echo 'selected="selected"'; ?>><?php lang('product_text_list'); ?></option>
                                                                        <option
                                                                            value="textlist" <?php if ($o_type[$i] == 'textlist') echo 'selected="selected"'; ?>><?php lang('product_select_dropdown'); ?></option>
                                                                        <option
                                                                            value="checkbox" <?php if ($o_type[$i] == 'checkbox') echo 'selected="selected"'; ?>><?php lang('product_checkbox'); ?></option>
                                                                        <option
                                                                            value="radio" <?php if ($o_type[$i] == 'radio') echo 'selected="selected"'; ?>><?php lang('product_button_radio'); ?></option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                            ...
                                                                            <div class="col-md-3 pull-right">
                                                                                <center>
                                                                                    <small><a href="javascript:void(0);"
                                                                                              onclick="dgUI.product.field(this,'remove')"><i
                                                                                                class="clip-close"></i></a>
                                                                                    </small>
                                                                                </center>
                                                                            </div>
                                                                            <div class="col-md-3 pull-right">
                                                                                <input type="text"
                                                                                       class="form-control input-sm"
                                                                                       value="<?php echo $o_prices[$i][$j]; ?>"
                                                                                       name="product[fields][<?php echo $i; ?>][prices][]">
                                                                            </div>
                                                                            <div class="col-md-5 pull-right">
                                                                                <input type="text"
                                                                                       class="form-control input-sm"
                                                                                       value="<?php echo $o_titles[$i][$j]; ?>"
                                                                                       name="product[fields][<?php echo $i; ?>][titles][]">
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="form-group">
                                        <a href="javascript:void(0);" onclick="dgUI.product.attribute('add')"
                ...
                <div class="tab-pane" id="panel_tab2_example2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group pull-right">
                                <a href="javascript:void(0);" id="add-new-color" class="btn btn-primary white"><i
                                        class="fa icon-plus"> <?php lang('product_add_color'); ?></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="clear-line"></div>
                    ...
                    <div class="table-responsive">
                            ...
                            if (isset($design->color_hex) && count($design->color_hex)) {
                                ...
                                for ($i = 0; $i < count($design->color_hex); $i++) {
                                    ...
                                    <tr id="color_<?php echo $i; ?>">
                                        <td class="center">
                                            <input type="hidden" value="<?php echo $design->color_hex[$i]; ?>"
                                                   name="product[design][color_hex][]">

                                            <?php
                                            $colors_hex = explode(';', $design->color_hex[$i]);
                                            for ($jc = 0; $jc < count($colors_hex); $jc++) {
                                                ?>
                                                <a style="background-color:#<?php echo $colors_hex[$jc]; ?>"
                                                   onclick="dgUI.product.color.edit('<?php echo $i; ?>.<?php echo $jc; ?>')"
                                                   href="javascript:void(0)" class="color"></a>
                                            <?php } ?>
                                        </td>

                                        <td class="center"><input type="text"
                                                                  value="<?php echo $design->color_title[$i]; ?>"
                                                                  name="product[design][color_title][]"></td>
                                        ...
                                        if (isset($design->price) && isset($design->price[$i]))
                                            ...
                                            $price_color = 0;
                                        ?>
                                        <td class="center"><input type="text" value="<?php echo $price_color; ?>"
                                                                  name="product[design][price][]" size="2"></td>

                                        <td class="center">
                                            <input type="hidden" id="front-products-design-<?php echo $i; ?>"
                                                   value="<?php echo $front; ?>" name="product[design][front][]">
                                            <img width="50" id="front-products-img-<?php echo $i; ?>"
                                                 src="<?php echo imageURL(getImgage($front)); ?>" alt=""> <br>
                                            <a onclick="dgUI.product.design(this, 'front')" class="pull-left"
                                               href="javascript:void(0)"><?php lang('configure'); ?></a>
                                            <a onclick="dgUI.product.removeDesign(this, 'front')" style="color:#ff0000;"
                                               class="pull-right" href="javascript:void(0)"><?php lang('remove'); ?></a>
                                        </td>

                                        <td class="center">
                                            <input type="hidden" id="back-products-design-<?php echo $i; ?>"
                                                   value="<?php echo $back; ?>" name="product[design][back][]">
                                            <img width="50" id="back-products-img-<?php echo $i; ?>"
                                                 src="<?php echo imageURL(getImgage($back)); ?>" alt=""> <br>
                                            <a onclick="dgUI.product.design(this, 'back')" class="pull-left"
                                               href="javascript:void(0)"><?php lang('configure'); ?></a>
                                            <a onclick="dgUI.product.removeDesign(this, 'back')" style="color:#ff0000;"
                                               class="pull-right" href="javascript:void(0)"><?php lang('remove'); ?></a>
                                        </td>

                                        <td class="center">
                                            <input type="hidden" id="left-products-design-<?php echo $i; ?>"
                                                   value="<?php echo $left; ?>" name="product[design][left][]">
                                            <img width="50" id="left-products-img-<?php echo $i; ?>"
                                                 src="<?php echo imageURL(getImgage($left)); ?>" alt=""> <br>
                                            <a onclick="dgUI.product.design(this, 'left')" class="pull-left"
                                               href="javascript:void(0)"><?php lang('configure'); ?></a>
                                            <a onclick="dgUI.product.removeDesign(this, 'left')" style="color:#ff0000;"
                                               class="pull-right" href="javascript:void(0)"><?php lang('remove'); ?></a>
                                        </td>

                                        <td class="center">
                                            <input type="hidden" id="right-products-design-<?php echo $i; ?>"
                                                   value="<?php echo $right; ?>" name="product[design][right][]">
                                            <img width="50" id="right-products-img-<?php echo $i; ?>"
                                                 src="<?php echo imageURL(getImgage($right)); ?>" alt=""> <br>
                                            <a onclick="dgUI.product.design(this, 'right')" class="pull-left"
                                               href="javascript:void(0)"><?php lang('configure'); ?></a>
                                            <a onclick="dgUI.product.removeDesign(this, 'right')" style="color:#ff0000;"
                                               class="pull-right" href="javascript:void(0)"><?php lang('remove'); ?></a>
                                        </td>

                                        <td class="center">
                                            <a onclick="dgUI.product.removeColor(this)"
                                               href="javascript:void(0)"><?php lang('remove'); ?></a>
                        ...
                        if (isset($design) && isset($design->area))
                            ...
                            $area = new stdClass();
                        ?>
                        <input type="hidden" value="<?php echo setValue($params, 'front', ''); ?>"
                               id="products-design-print-front" name="product[design][params][front]"/>
                        <input type="hidden" value="<?php echo setValue($params, 'back', ''); ?>"
                               id="products-design-print-back" name="product[design][params][back]"/>
                        <input type="hidden" value="<?php echo setValue($params, 'left', ''); ?>"
                               id="products-design-print-left" name="product[design][params][left]"/>
                        <input type="hidden" value="<?php echo setValue($params, 'right', ''); ?>"
                               id="products-design-print-right" name="product[design][params][right]"/>
                        <input type="hidden" value="<?php echo setValue($area, 'front', ''); ?>"
                               id="products-design-area-front" name="product[design][area][front]"/>
                        <input type="hidden" value="<?php echo setValue($area, 'back', ''); ?>"
                               id="products-design-area-back" name="product[design][area][back]"/>
                        <input type="hidden" value="<?php echo setValue($area, 'left', ''); ?>"
                               id="products-design-area-left" name="product[design][area][left]"/>
                        <input type="hidden" value="<?php echo setValue($area, 'right', ''); ?>"
                               id="products-design-area-right" name="product[design][area][right]"/>
                    ...
                    foreach ($pArray as $cate) {
                        if (strtolower($cate['cate_name']) == 'color') {
                            $color_flag = "style='display: none'";
                        }
                        $main_options .= "<option id='" . strtolower($cate['cate_name']) . "' " . $color_flag . ">" . $cate['cate_name'] . "</option>";
                        if (strtolower($cate['cate_name']) == 'color') {
                            $colors = $cate['products'];
                            continue;
                        }
                    ...
                    ?>
                    <a href="#" id="add-new-details" class="btn btn-primary white"><i class="fa icon-plus"> Add/Get Diy
                            Details</i></a><br/>
                    <table id="diy_toolbar" style="border: 1px dotted #0074A2;width: 100%; display: none">
                        <tr>
                            ...
                            <td><a href="#" id="add-new-variant" class="btn btn-primary white"><i
                                        class="fa fa-plus-square-o fa-2x" aria-hidden="true"></i></a></td>
                        </tr>
                    </table>
                    <div id="diy_config_feld" style="display: none"><br/>
                        <!--								<span>Test Input</span><input type="text" name="testInput" value="Xulin Test" />-->
                    </div>
                    <!-- input to transfer configed design json container -->
                    <input id="config_json_container" name="config_json_container" type="hidden" value=""/>
                    <input id="color_ids_container" name="color_ids_container" type="hidden" value=""/>
...
<div id="add-view" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        window.onload = function () {
            var post_id = parent.iframe_loaded();
            ...
            current_color.find('div').each(function () {
                ...
                current_part_wp.find('div.variant_box').each(function () {
                    ...
                    if (var_index == 0) {
                        ...
                        current_variant.push({"typ": "var_" + var_index});
                        var_index++;
                    }
...
//							current_variant.push({"active":current_variant_wp.find("select option:selected").text()});
    ...
    jQuery("#add-new-variant").click(function () {
        ...
        if (jQuery("#diy_config_feld > div.design_box div." + main_selected).length == false) {
            var table_html = get_single_block_for_design(main_selected, variant_selected_name, variant_selected_sku, id_to_detect, true);
            ...
            if (jQuery("#diy_config_feld > div.design_box div." + main_selected + " div.variant_box[var_type*='" + variant_selected_name + "']").length != false) {
                ...
                var single_variant_box_html = get_single_block_for_design('', variant_selected_name, variant_selected_sku, id_to_detect);
    ...
    function get_single_block_for_design(cate, var_name, var_sku, color_id ,with_default = false) {
        if (with_default != false) {
            var html = "<div class='" + cate.toLowerCase() + "' >" +
                "<h4 style='margin-left: 7px; color: #428BCA'>" + cate + "</h4>" +
                get_variant_for_table('default', '', color_id) +
                get_variant_for_table(var_name, var_sku, color_id);
            html = html + "</div><hr style='display: block;height: 2px;border-top: 3px solid #4299D8;'/>";
            return html;
        } else {
            return get_variant_for_table(var_name, var_sku, color_id);
        }
    }

    function get_variant_for_table(name, sku, img_flag) {
        var flag = '';
        if (name == 'default') {
            flag = 'disabled';
        }
        var html = "<div class='variant_box' var_sku='" + sku + "' var_type='" + name + "' style='margin-left: 7px'>" +
            ...
            "<span>Bild: </span><input type='file' name='testIMG[]' class='img_path' style='margin-bottom: 7px' multiple><br />" +
...
//				alert("now active: "+active_option+" and to show: "+select_to_show);
    ...
    jQuery('#add-new-details').click(function () {
        ...
        jQuery("tr[id*='color_']").each(function () {
            ...
            function get_target_color(element) {
                return element.product_name.toLowerCase() == design_color.toLowerCase();
            }
