...
<!--	xulin	Load design Field Start	-->
			...
			?>
			<iframe id="config_iframe" width="100%" height="650px" frameBorder="0" scrolling="no" src="<?php
			echo "http://".$_SERVER['SERVER_NAME']."/tshirtecommerce/index.php?product=".$cutom_id."&parent=".get_the_ID();
			?>"></iframe>
